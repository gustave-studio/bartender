...
const MessageWindow = function () {
  ...
  const selectMenu = (drink: string, key: number) => {
    ...
    switch (choices[key]) {
      ...
      // 自分に合ったお酒を探したい > ウィスキー > 私の好みに合わせておすすめ教えて > クセのない方が好き
      case 'クセのない方が好き': {
      ...
      // 自分に合ったお酒を探したい > ウィスキー > 私の好みに合わせておすすめ教えて > クセのない方が好き > シンプルでスッキリしたウィスキー
      case 'シンプルでスッキリしたウィスキー': {
      ...
      // 自分に合ったお酒を探したい > ウィスキー > 私の好みに合わせておすすめ教えて > クセのない方が好き > マイルドで飲みやすいウィスキー
      case 'マイルドで飲みやすいウィスキー': {
      ...
      // 自分に合ったお酒を探したい > ウィスキー > 私の好みに合わせておすすめ教えて > クセのない方が好き > 爽やかなウィスキー
      case '爽やかなウィスキー': {
      ...
      // 自分に合ったお酒を探したい > ウィスキー > 私の好みに合わせておすすめ教えて > クセがあっても大丈夫
      case 'クセがあっても大丈夫': {
      ...
      // 自分に合ったお酒を探したい > ウィスキー > 私の好みに合わせておすすめ教えて > クセがあっても大丈夫 > コクと甘みを感じるウィスキー
      case 'コクと甘みを感じるウィスキー': {
      ...
      // 自分に合ったお酒を探したい > ウィスキー > 私の好みに合わせておすすめ教えて > クセがあっても大丈夫 > 爽やかなウィスキー
      case 'スモーキーでほのかに甘いウィスキー': {
      ...
      // 自分に合ったお酒を探したい > ウィスキー > 私の好みに合わせておすすめ教えて > クセがあっても大丈夫 > 最強にスモーキーなウィスキー
      case '最強にスモーキーなウィスキー': {
      ...
      case 'スッキリしていて爽やかなカクテル': {
        ...
        setCocktailsRecipes([recipie101, recipie102, recipie103]);
        setCocktailIngredients([ingredient101, ingredient102, ingredient103]);
        break;
      }
      // カクテル > 家でも楽しめるカクテルがいい > オレンジジュースみたいなカクテル
      case 'オレンジジュースみたいなカクテル': {
        ...
        setCocktailsRecipes([recipie201, recipie202]);
        setCocktailIngredients([ingredient201, ingredient202]);
        break;
      }
      ...
      case 'トマトのフレッシュなカクテル': {
        ...
        setCocktailsRecipes([recipie301, recipie302]);
        setCocktailIngredients([ingredient301, ingredient302]);
        break;
      }

      // カクテル > お店で飲むような本格的なカクテルがいい
      case 'お店で飲むような本格的なカクテルがいい': {
      ...
      case 'ロマンチックなカクテル': {
        ...
        setCocktailsRecipes([recipie401, recipie402, recipie403]);
        setCocktailIngredients([ingredient401, ingredient402, ingredient403, ingredient404]);
        break;
      }
      ...
      case '爽やかで上品なカクテル': {
        ...
        setCocktailsRecipes([recipie501, recipie502, recipie503]);
        setCocktailIngredients([ingredient501, ingredient502, ingredient503, ingredient504]);
        break;
      }

      // カクテル > お店で飲むような本格的なカクテルがいい > 甘ずっぱくて爽快感のあるカクテル
      case '甘ずっぱくて爽快感のあるカクテル': {
        ...
        setCocktailsRecipes([recipie601, recipie602, recipie603]);
        setCocktailIngredients([ingredient601, ingredient602, ingredient603, ingredient604]);
        break;
      }
